defmodule ExOpenSea.Collections.ListTest do
  ...
  test ".get/1 can filter by limit" do
  ...
  test ".get/1 can filter by offset" do
  ...
  test ".get/1 returns an error for negative offsets" do
  ...
  test ".get/1 returns an error for negative limit" do
